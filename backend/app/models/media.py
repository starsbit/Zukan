...
class Media(Base):
    ...
    is_nsfw_override: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    is_sensitive_override: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    ...
    metadata_review_dismissed: Mapped[bool] = mapped_column(
        Boolean,
        nullable=False,
        default=False,
